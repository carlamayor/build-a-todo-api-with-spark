...
public class AppClient {
    ...
    public AppResponse request(String method, String uri) {
        return request(method, uri, null);
    }

    public AppResponse request(String method, String uri, String requestBody) {
        try {
            ...
            return new AppResponse(connection.getResponseCode(), body);
        } catch (IOException e) {
            e.printStackTrace();
